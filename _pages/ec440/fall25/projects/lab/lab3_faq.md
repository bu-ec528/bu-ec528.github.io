---
title: ""
permalink: /EC440/fall25/projects/lab3/faq
...
####  <span style="color:Crimson;">**Do we need a working Project 2 to implement Project 3?** </span>

 <span style="color:Crimson;">**Yes.** </span>
...
Returning from `page_fault()` resumes the current user process (see section [Internal Interrupt Handling](../reference/interrupt-handling.md#2-internal-interrupt-handling)). It will then retry the instruction to which the instruction pointer points.
