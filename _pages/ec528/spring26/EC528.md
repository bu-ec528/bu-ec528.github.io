...
**Office Hours:** Mon: 3:30 - 4:30PM (or by appointment), PHO305
...
The available involvement scores are 140%, 120%, 100%, 80%, and 60%. These scores reflect each member’s relative contribution to the team effort. The sum of the involvement scores across all team members should be approximately 100% on average. For example, if one member is assigned 60%, the remaining 40% must be distributed among the other team members.
...
* There will be 14 brief in-class quizzes based on the assigned readings.
* MS students must complete 10 out of 14 quizzes.
* Undergraduate students must complete 8 out of 14 quizzes.
