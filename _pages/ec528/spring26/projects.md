---
title: ""
permalink: /ec528/fall25/projects/
...
| [(Optional) Lab4: File Systems](./projects/lab/lab4.md) | 11/16 |  12/17 11:59 PM EST  | File System | 20 | 
...
To get started, you need to clone the [Pintos repository](https://github.com/yigonghu/ec528-pintos.git) we provided.

```
$ git clone https://github.com/yigonghu/ec528-pintos.git
```
...
* If you are using docker image, run the docker image and mount your <span style="color:Crimson">`path/to/pintos`</span>
    ...
    ```
    docker run -it --rm --name pintos --mount type=bind,source=/path/to/pintos,target=/home/BUOS/pintos buec528/pintos bash
    ```
