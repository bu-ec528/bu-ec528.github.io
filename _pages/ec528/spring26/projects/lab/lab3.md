---
title: ""
permalink: /ec528/fall25/projects/lab3
...
<span style="color:Crimson;">**You will build this assignment on top of the last one.**</span>
...
**You will continue to handle Pintos disks and file systems** **the same way you did in the previous assignment** (see section [Using the File System](./lab2_background.md#2-using-the-file-system)).

**Here are the sections in this chapter:**
Here are the sections in this chapter:

* [Background](./lab3_background.md)

* [Project 3a Requirements](./lab3_requirement.md)
