---
title: ""
permalink: /ec528/fall25/projects/setup
...
```
docker run -it buec528/pintos bash
```
...
We've provided a [script](https://github.com/yigonghu/ec528-pintos/blob/main/src/misc/toolchain-build.sh) (pintos/src/misc/toolchain-build.sh) that automates the building instructions. So you can just run the script and modify your PATH setting after the build finishes. The script has been tested on recent version of Ubuntu, Mac OS and Fedora.
